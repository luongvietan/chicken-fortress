    ...
    <footer data-animate="footer" className="bg-surface-container w-full mt-auto">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-2 font-headline text-sm">
          ...
          <Link className="text-on-surface-variant hover:underline transition-all" href={`/${locale}#features`}>
            {t(locale, landingCopy.footer.links.features)}
          </Link>
          <Link className="text-on-surface-variant hover:underline transition-all" href={`/${locale}#specs`}>
            {t(locale, landingCopy.footer.links.specs)}
          </Link>
          <Link className="text-on-surface-variant hover:underline transition-all" href={`/${locale}#details`}>
            {t(locale, landingCopy.footer.links.details)}
          </Link>
