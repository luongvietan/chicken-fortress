    ...
    >
      <div className="lg:col-span-6 space-y-8">
        <div className="flex flex-col gap-3">
          <span
            data-anim="subtitle"
            className="text-tertiary font-bold tracking-widest uppercase text-sm"
          >
            {t(locale, landingCopy.hero.tagline)}
          </span>
          <h1
            data-anim="title"
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          <a
            href="#products"
            data-anim="cta"
            className="bg-primary text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl font-bold flex items-center gap-2 hover:opacity-90 transition-opacity"
          >
